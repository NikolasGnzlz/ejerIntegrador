...
public class AutomovilDAOImpl extends Conexion implements AutomovilDAO {
    ...
    public void delete(Integer id) throws DAOException {
        ...
        try {
            this.conectar();
            PreparedStatement sentencia = this.conexion.prepareStatement(consulta);//"DELETE from automovil where id = ?");
            sentencia.executeUpdate(consulta);                               //sentencia.setInt(1, automovil.getId());
